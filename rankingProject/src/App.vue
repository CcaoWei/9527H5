    ...
    <el-row class="ranking-wrap">
      ...
      <el-col class="ranking-col-left" :span="12">
        ...
        <ul class="ranking-list">
          <li class="ranking-list-item" v-for="(item, index) in rankingDataExpert" :key="item.userId + 'c'">
            <div class="ranking-list-item-left">
              <img v-if="index < 3" class="ranking-num" :src="'https://wx-miniprogram-source.oss-cn-beijing.aliyuncs.com/h5img/ranking_'+(index+1)+'.png'" />
      ...
      <el-col class="ranking-col-right" :span="12">
        ...
        <ul class="ranking-list">
          <li class="ranking-list-item" v-for="(item, index) in rankingDataGames" :key="item.userId + 'g'">
            <div class="ranking-list-item-left">
              <img v-if="index < 3" class="ranking-num" :src="'https://wx-miniprogram-source.oss-cn-beijing.aliyuncs.com/h5img/ranking_'+(index+1)+'.png'" />
              <div v-else class="ranking-num">
                {{index + 1}}
    ...
    <div class="footer">
      <div class="footer-left">
        ...
        <ul class="footer-list-wrap">
          <li class="footer-list-item" v-for="item in popularData" :key="item.gid">
...
.page {
    ...
    .ranking-wrap {
      ...
      .ranking-list {
        ...
        .ranking-list-item:nth-child(5) .ranking-list-item-right {
          border-bottom: none;
        }
      }
    }
